...
while guess==0:
    ...
    if pergunta1 in x:
        ...
        tartaruga.pendown()
        tartaruga.write(pergunta1,move=True,align="left",font=("Arial",20,"normal"))
    else:
        head()
        guess+=1
...
while guess==1:
    ...
    if pergunta2 in x:
        tartaruga.penup()
        tartaruga.setpos(1,0)
        tartaruga.pendown()
        tartaruga.write(pergunta2,move=True,align="left",font=("Arial",20,"normal")) 
    else:
        body()
        guess+=1        
while guess==2: 
     ...
     if pergunta3 in x:
         tartaruga.penup()
         tartaruga.setpos(2,0)
         tartaruga.pendown()
         tartaruga.write(pergunta3,move=True,align="left",font=("Arial",20,"normal"))
     else:
        arm1()
        guess+=1
...
while guess==3:
    ...
    if pergunta4 in x:
        tartaruga.penup()
        tartaruga.setpos(3,0)
        tartaruga.pendown()
        tartaruga.write(pergunta4,move=True,align="left",font=("Arial",20,"normal"))
    else:
        arm2()
        guess+=1
...
while guess==4:
    ...
    if pergunta5 in x:
        tartaruga.penup()
        tartaruga.setpos(4,0)
        tartaruga.pendown()
        tartaruga.write(pergunta5,move=True,align="left",font=("Arial",20,"normal"))
    else:
        leg1()
        guess+=1
...
while guess==5:
    ...
    if pergunta6 in x:
        tartaruga.penup()
        tartaruga.setpos(5,0)
        tartaruga.pendown()
        tartaruga.write(pergunta6,move=True,align="left",font=("Arial",20,"normal"))
    else:
        leg2()
        guess+=1
